...
class ComplexityPerformanceContractV2Tests(unittest.TestCase):
    ...
    def test_contract_derives_every_active_cell_and_complete_budget_matrix(self) -> None:
        ...
        self.assertEqual(report["active_option_cell_count"], 47)
        self.assertEqual(report["resolved_capability_count"], 47)
        self.assertEqual(report["resolved_budget_count"], 470)
        self.assertEqual(report["expected_capability_current_measurements"], 752)
    ...
    def test_empty_measurement_set_never_passes_product_finalization(self) -> None:
        ...
        self.assertEqual(report["missing_capability_measurement_count"], 752)
