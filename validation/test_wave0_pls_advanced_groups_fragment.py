...
class Wave0PlsAdvancedGroupsFragmentTests(unittest.TestCase):
    @classmethod
    ...
    def test_fragment_has_frozen_wire_shape_and_disjoint_expected_rows(self) -> None:
        ...
        self.assertTrue(
            ...
            "Wave-0 source fragments must remain row-disjoint.",
        )
    ...
    def test_every_registry_cell_is_exact_active_parity_without_state_inference(
        ...
        for assessment in self.fragment["cell_assessments"]:
            ...
            self.assertTrue(
                ...
                "Official workflow capture must not promote QuickPLS state.",
            )
    ...
    def test_all_nine_dimensions_are_captured_with_official_only_sources(self) -> None:
                ...
                if ".documented." in item["item_id"]:
                    ...
                    self.assertTrue(
                        any(
                            ...
                            for criterion in item["acceptance_criteria"]
                            for token in ("capture", "fixture", "ledger", "matrix")
                        ),
    ...
    def test_fragment_loader_and_wave0_contract_accept_isolated_fragment(self) -> None:
        matrix = copy.deepcopy(self.matrix)
        matrix["override_fragments"] = [FRAGMENT_RELATIVE_PATH]
        matrix["overrides"] = {
            "cell_assessments": [],
            "dimension_assessments": [],
        }
