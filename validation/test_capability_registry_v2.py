...
class CapabilityRegistryV2Tests(unittest.TestCase):
    ...
    def test_authoritative_baseline_and_local_references_pass(self):
        ...
        self.assertEqual(report["qualification_link_count"], 52)
        self.assertEqual(report["option_cell_count"], 52)
        self.assertEqual(
            report["option_cell_coverage_counts"],
            {"full": 0, "partial": 39, "absent": 11, "intentionally_excluded": 2},
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            {"standard": 29, "labs": 21, "legacy": 2, "internal": 0},
        )
