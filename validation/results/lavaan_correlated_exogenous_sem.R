...
data <- read.csv("D:\\QuickPLS\\validation\\results\\lavaan_correlated_exogenous_sem.csv")
...
writeLines(jsonlite::toJSON(payload, auto_unbox=TRUE, pretty=TRUE, na="null", digits=16), "D:\\QuickPLS\\validation\\results\\lavaan_correlated_exogenous_sem_reference.json")
