...
data <- read.csv("D:\\QuickPLS\\validation\\results\\lavaan_three_factor_cfa.csv")
...
writeLines(jsonlite::toJSON(payload, auto_unbox=TRUE, pretty=TRUE, na="null", digits=16), "D:\\QuickPLS\\validation\\results\\lavaan_three_factor_cfa_reference.json")
