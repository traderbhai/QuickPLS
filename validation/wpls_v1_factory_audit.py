"""Final fail-closed release audit for bounded WPLS v1."""
...
from wpls_v1_factory_common import ROOT, manifest, strict_load_json, write_identity_report


SOURCE = "validation/wpls_v1_factory_audit.py"
...
def evaluate_audit_inputs(document: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    semantic = {
        ...
        "invalid_weight_fails_closed": native.get("checks", {}).get("invalid_weight_blocked") is True and native.get("checks", {}).get("invalid_weight_created_no_state") is True,
