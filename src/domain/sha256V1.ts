...
/** Deterministic synchronous SHA-256 for small scientific identity inputs. */
export function sha256HexBytesV1(input: Uint8Array): string {
...
export function sha256HexUtf8V1(input: string): string {
  return sha256HexBytesV1(new TextEncoder().encode(input));
}
