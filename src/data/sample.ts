...
export const methods: MethodDefinition[] = [
  ...
  { id: "pls_sample_size_power", family: "PLS-SEM", name: "Prospective sample-size and power analysis", status: "validated" },
  ...
  { id: "predict", family: "Prediction", name: "PLSpredict / CVPAT", status: "validated" },
  { id: "mga", family: "Groups", name: "MICOM v3.1", status: "experimental" },
