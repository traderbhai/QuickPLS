...
export const methods: MethodDefinition[] = [
  ...
  { id: "bootstrap", family: "PLS-SEM", name: "Bootstrapping", status: "experimental" },
  { id: "permutation", family: "PLS-SEM", name: "Freedman-Lane permutation", status: "experimental" },
  { id: "plsc", family: "PLS-SEM", name: "Consistent PLS", status: "experimental" },
  { id: "wpls", family: "PLS-SEM", name: "Weighted PLS", status: "experimental" },
  { id: "cca", family: "PLS-SEM", name: "Confirmatory composite analysis", status: "experimental" },
  { id: "cta_pls", family: "PLS-SEM", name: "Confirmatory tetrad analysis", status: "experimental" },
  { id: "endogeneity", family: "PLS-SEM", name: "Gaussian-copula endogeneity analysis", status: "experimental" },
  ...
  { id: "predict", family: "Prediction", name: "PLSpredict holdout / repeated k-fold", status: "experimental" },
  { id: "mga", family: "Groups", name: "Bounded two-group MGA", status: "experimental" },
  { id: "ipma", family: "Prediction", name: "IPMA / cIPMA", status: "experimental" },
  { id: "cbsem", family: "CB-SEM", name: "CFA / ML SEM", status: "experimental" },
  { id: "pca", family: "Components", name: "Principal component analysis", status: "experimental" },
  ...
  { id: "nca", family: "Necessary conditions", name: "NCA", status: "experimental" },
];
