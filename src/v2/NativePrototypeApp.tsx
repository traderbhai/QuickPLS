...
function Dialog({
  ...
  const body = {
    ...
    about: <div className="np-doc-browser"><section><h3>QuickPLS 2.51.0</h3><p>Independent offline structural equation modeling for Windows.</p></section><section><h3>Release channel</h3><p>Unsigned preview candidate. Verify the attached SHA-256 checksums before running downloaded artifacts.</p></section><section><h3>Unified workflow</h3><p>Scoped-Standard mediation, moderation, higher-order PLS, moderated mediation, and bounded CB-SEM use one Canvas, Calculate, Results, export, and reopen experience.</p></section></div>,
