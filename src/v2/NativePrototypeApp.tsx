...
function Dialog({
  ...
  const body = {
    ...
    about: <div className="np-doc-browser"><section><h3>QuickPLS 2.55.4</h3><p>Independent offline structural equation modeling for Windows.</p></section><section><h3>Release channel</h3><p>Source candidate. The unsigned Windows candidate, checksum package, and packaged smoke are pending for this version.</p></section><section><h3>Unified workflow</h3><p>Authority-aware Canvas editing, model navigation and arrangement, diagram-native advanced relationships, and researcher-facing Results use one Canvas, Calculate, Results, export, and reopen experience.</p></section></div>,
