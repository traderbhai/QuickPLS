...
diagnostic `20260823T000930Z` at source
`d5b508aa9e8703dfc169a9f224ee76d9a2796d02` passed 14/14, including 453/453
Vitest suites, 1722/1722 tests, all 17 rebaseline assertions, and zero captured
console errors. Its authoritative report is
`validation/results/v255_consolidated_diagnostics_20260823T000930Z/v255_consolidated_diagnostics.json`
with SHA-256 `F83542DC2BD6427F00583842932B00CB6F551814FBA0BD636F01AB1F0B99C562`.
...
The superseded diagnostics `20260822T202919Z` and `20260822T224933Z`, failed diagnostic attempt
`20260822T223906Z`, candidate builds `20260822T205741Z` and `20260822T230754Z`, portable probes
`20260822T214629Z` and `20260822T233111Z`, and all other later failed, probe, or build attempts are
...
Local versioned builds write setup, portable, CLI, and checksum files to `target/release/artifacts/`. The superseded diagnostics `20260822T202919Z` and `20260822T224933Z`, failed diagnostic attempt `20260822T223906Z`, candidate builds `20260822T205741Z` and `20260822T230754Z`, portable probes `20260822T214629Z` and `20260822T233111Z`, and all other later failed, probe, or build attempts are historical and ineligible. The marker-only install comparison is corrected but has no eligible packaged proof. One fresh provenance-bound unsigned candidate must still be built and complete the required isolated install plus full installed-and-portable smoke before evidence collection, bundling, and publication. The latest published files remain the verified Version 2.54.0 setup, portable app, CLI, and checksums on the [`v2.54.0` release page](https://github.com/traderbhai/QuickPLS/releases/tag/v2.54.0).
