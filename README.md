...
Local versioned builds write setup, portable, and checksum files to `target/release/artifacts/`. GitHub release notes should point to the matching checksum file for the uploaded version.
...
- [FAQ](docs/FAQ.md)
- [Release Notes v2.45.0](docs/V2_45_0_MOCKUP_VISIBLE_FEATURE_COMPLETION.md)
