...
4. **Complete:** correct the focused fixture-test access that caused the sole TypeScript `TS2339` failure, then close the bounded named-route and persistence defects exposed by the now-ineligible candidate/probe records.
5. **Complete:** run the identical diagnostic script and suite/invocation contract after the bounded corrections. The formal final report is `validation/results/v255_consolidated_diagnostics_20260822T183205Z/v255_consolidated_diagnostics.json`, is bound to source `0fa74eb`, and passed 14/14, including 453/453 Vitest suites, 1702/1702 tests, 17/17 rebaseline assertions, and zero captured console errors. Both formal diagnostics use runner SHA-256 `64969b4eb89c9789e586c372532d89b082766a44661cc4feea66b6cf3a0f9796`.
...
- The formal first 14-step diagnostic executed every step and passed 13; its sole failure was `frontend_typecheck` with TypeScript error `TS2339` in `src/data/v255NamedSemEvidenceFixtures.test.ts`. The same-script, same-suite formal final diagnostic passed 14/14. The formal reports are separate and are not byte-identical. Renderer console/page errors fail closed, attach-only journeys have fresh wrapper-owned process boundaries, and candidate/phase/trusted-driver roles and hashes are bound. Candidate/install/smoke/probe attempts `20260822T163918Z`, `20260822T170818Z`, `20260822T173336Z`, `20260822T174301Z`, `20260822T175510Z`, and every earlier 2.55 candidate, install, smoke, or probe attempt are historical and ineligible. One new unsigned 2.55 candidate build, isolated installation, full installed-and-portable/native-DPI smoke, evidence collection and bundling, final audit, and publication have not yet run.
...
The retained formal first diagnostic is fixed at `validation/results/v255_consolidated_diagnostics_20260822T142953Z/`; it is failure evidence, not a green release authority. The formal final green report and its exact Vitest JSON are fixed under `validation/results/v255_consolidated_diagnostics_20260822T183205Z/`. Build one new candidate, then replace the candidate placeholders below with paths from that new report. Do not use candidate/install/smoke/probe attempts `20260822T163918Z`, `20260822T170818Z`, `20260822T173336Z`, `20260822T174301Z`, `20260822T175510Z`, any earlier 2.55 candidate, install, smoke, or probe attempt, or their hashes.
...
powershell -NoProfile -ExecutionPolicy Bypass -File validation/run_v255_installed_portable_smoke.ps1 `
  ...
  -VitestReportPath validation/results/v255_consolidated_diagnostics_20260822T183205Z/v255_full_vitest.json `
  -ConsolidatedReportPath validation/results/v255_consolidated_diagnostics_20260822T183205Z/v255_consolidated_diagnostics.json `
...
python validation/v255_product_completion_audit.py --publication-stage `
  ...
  --vitest-report validation/results/v255_consolidated_diagnostics_20260822T183205Z/v255_full_vitest.json `
  --rebaseline-report validation/results/v255_consolidated_diagnostics_20260822T183205Z/interaction_contracts/v255_rebased_interaction_contracts.json `
  ...
  --final-consolidated-report validation/results/v255_consolidated_diagnostics_20260822T183205Z/v255_consolidated_diagnostics.json `
