...
4. **Complete:** correct the focused fixture-test access that caused the first TypeScript `TS2339` failure, then close the later strict schema-6 adoption, exact-result readback, metadata-only lineage, and packaged-route defects in one focused source batch. Intermediate diagnostic attempt `20260822T202158Z` is historical and is not the final authority.
5. **Complete:** run the identical diagnostic script and suite/invocation contract after the final source correction. The formal final report is `validation/results/v255_consolidated_diagnostics_20260822T202919Z/v255_consolidated_diagnostics.json`, is bound to source `de439880067b2083d881d935f59369f602768499`, and passed 14/14, including 453/453 Vitest suites, 1707/1707 tests, 17/17 rebaseline assertions, and zero captured console errors. Its SHA-256 is `5edd87da8b45f4ce7ebdfaa51f60c535364d6a1eced3e20832a719b5c5ef0d07`. Both formal diagnostics use runner SHA-256 `64969b4eb89c9789e586c372532d89b082766a44661cc4feea66b6cf3a0f9796`.
6. **Complete:** record the final green gate evidence in commit `099ef03`, then restore and commit only the approved 2.55 version and release-document authorities. The 2.55 authority commit descends from the final green source-gate evidence and contains no post-gate product-code change.
...
- The formal first 14-step diagnostic executed every step and passed 13; its sole failure was `frontend_typecheck` with TypeScript error `TS2339` in `src/data/v255NamedSemEvidenceFixtures.test.ts`. The same-script, same-suite formal final diagnostic `20260822T202919Z` passed 14/14. The formal reports are separate and are not byte-identical. Renderer console/page errors fail closed, attach-only journeys have fresh wrapper-owned process boundaries, and candidate/phase/trusted-driver roles and hashes are bound. The intermediate diagnostic attempt `20260822T202158Z`, the candidate build `20260822T190446Z`, its portable probe `20260822T192919Z`, and all earlier 2.55 candidate, install, or smoke attempts are historical and ineligible. One new unsigned 2.55 candidate build, isolated installation, full installed-and-portable/native-DPI smoke, evidence collection and bundling, final audit, and publication have not yet run.
...
The retained formal first diagnostic is fixed at `validation/results/v255_consolidated_diagnostics_20260822T142953Z/`; it is failure evidence, not a green release authority. The formal final green report and its exact Vitest JSON are fixed under `validation/results/v255_consolidated_diagnostics_20260822T202919Z/`. Build one new candidate, then replace the candidate placeholders below with paths from that new report. Do not use intermediate diagnostic attempt `20260822T202158Z`, candidate build `20260822T190446Z`, portable probe `20260822T192919Z`, any earlier 2.55 candidate, install, or smoke attempt, or their hashes.
...
powershell -NoProfile -ExecutionPolicy Bypass -File validation/run_v255_installed_portable_smoke.ps1 `
  ...
  -VitestReportPath validation/results/v255_consolidated_diagnostics_20260822T202919Z/v255_full_vitest.json `
  -ConsolidatedReportPath validation/results/v255_consolidated_diagnostics_20260822T202919Z/v255_consolidated_diagnostics.json `
...
python validation/v255_product_completion_audit.py --publication-stage `
  ...
  --vitest-report validation/results/v255_consolidated_diagnostics_20260822T202919Z/v255_full_vitest.json `
  --rebaseline-report validation/results/v255_consolidated_diagnostics_20260822T202919Z/interaction_contracts/v255_rebased_interaction_contracts.json `
  ...
  --final-consolidated-report validation/results/v255_consolidated_diagnostics_20260822T202919Z/v255_consolidated_diagnostics.json `
