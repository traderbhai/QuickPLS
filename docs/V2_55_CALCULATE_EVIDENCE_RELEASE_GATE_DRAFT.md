...
5. **Complete:** run the identical diagnostic script and suite/invocation contract after the correction. The formal final report is `validation/results/v255_consolidated_diagnostics_20260822T155928Z/v255_consolidated_diagnostics.json`, is bound to source `6aa92b7`, and passed 14/14, including 453/453 Vitest suites, 1697/1697 tests, 17/17 rebaseline assertions, and zero captured console errors. Both formal diagnostics use runner SHA-256 `64969b4eb89c9789e586c372532d89b082766a44661cc4feea66b6cf3a0f9796`.
...
The retained formal first diagnostic is fixed at `validation/results/v255_consolidated_diagnostics_20260822T142953Z/`; it is failure evidence, not a green release authority. The formal final green report and its exact Vitest JSON are fixed under `validation/results/v255_consolidated_diagnostics_20260822T155928Z/`. Build one new candidate, then replace the candidate placeholders below with paths from that new report. Do not use candidate/install/smoke attempts `20260822T145055Z`, `20260822T151222Z`, any earlier 2.55 candidate, install, or smoke attempt, or their hashes.
...
powershell -NoProfile -ExecutionPolicy Bypass -File validation/run_v255_installed_portable_smoke.ps1 `
  ...
  -VitestReportPath validation/results/v255_consolidated_diagnostics_20260822T155928Z/v255_full_vitest.json `
  -ConsolidatedReportPath validation/results/v255_consolidated_diagnostics_20260822T155928Z/v255_consolidated_diagnostics.json `
...
python validation/v255_product_completion_audit.py --publication-stage `
  ...
  --vitest-report validation/results/v255_consolidated_diagnostics_20260822T155928Z/v255_full_vitest.json `
  --rebaseline-report validation/results/v255_consolidated_diagnostics_20260822T155928Z/interaction_contracts/v255_rebased_interaction_contracts.json `
  ...
  --final-consolidated-report validation/results/v255_consolidated_diagnostics_20260822T155928Z/v255_consolidated_diagnostics.json `
