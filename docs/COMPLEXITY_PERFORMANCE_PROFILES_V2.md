...
The current Registry V2 binding contains 43 active catalogue rows and 49 active
option cells. Each cell resolves to 10 profile budgets: five profiles on each
of the Standard and Workstation hardware classes, for 490 resolved budgets.
