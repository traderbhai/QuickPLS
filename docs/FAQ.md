...
script and suite contract. A fresh
unsigned candidate, installed/portable packaged evidence, the evidence bundle,
and publication are still pending. The latest published public pre-release remains
