...
Current source version: **2.55.4**. The 2.55.0 evidence described below is
historical and does not qualify a 2.55.4 package. Formal first diagnostic `20260822T142953Z`
