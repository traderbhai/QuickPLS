...
| Prediction/heterogeneity | Validated for documented bounded scope | Indicator-level PLSpredict / CVPAT v2, IPMA, MICOM v2 plus two-group permutation MGA v2, FIMIX, and PLS-POS where audited; `plspredict_holdout_v1` and `micom_v1` artifact IDs are retained for archive compatibility | Randomized-fold parity, comparisons between separately saved models, claims beyond bounded MICOM/MGA v2, unbounded segmentation claims, and unsupported generated shapes |
